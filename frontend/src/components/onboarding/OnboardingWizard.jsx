...
export default function OnboardingWizard() {
  ...
  useEffect(() => {
    if (newStep !== 'userName' && firstName) { saveUserNames(); } // fire once leaving
      ...
      <div className="max-w-2xl mx-auto py-10">
        ...
        {newStep === 'greeting' && (
          <div>
            ...
            <p className="text-sm text-gray-600 mb-4">You can change these later.</p>
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div>
                ...
                {introMode === 'script' && <textarea rows={3} className="w-full border rounded p-2 text-sm placeholder:text-gray-400" value={introScript} placeholder="e.g., Welcome to my podcast" onChange={e => setIntroScript(e.target.value)} />}
              </div>
              <div>
                ...
                {outroMode === 'script' && <textarea rows={3} className="w-full border rounded p-2 text-sm placeholder:text-gray-400" value={outroScript} placeholder="e.g., Thank you for listening and see you next time!" onChange={e => setOutroScript(e.target.value)} />}
              </div>
            </div>
            <div className="mb-6">
