      ...
      <Card className="border-l-4 border-l-blue-500 bg-blue-50">
        <CardContent className="pt-6">
          ...
          <p className="text-sm text-blue-800 mb-3">
            This page lets you edit the <strong>testimonials/reviews</strong> and <strong>FAQ section</strong> that appear at the bottom 
            of the front page. These sections display content from the database and update immediately when you save changes.
          </p>
          <h4 className="font-semibold text-blue-900 mb-2 mt-4">🔒 What You Can't Edit Here</h4>
          <p className="text-sm text-blue-800">
            The following sections are <strong>hardcoded</strong> and require developer changes to modify:
          </p>
          ...
          <p className="text-sm text-blue-700 mt-3 italic">
            💡 If you need to change any of the hardcoded sections, please contact the developer to update the <code className="bg-blue-100 px-1 rounded">NewLanding.jsx</code> file.
          </p>
        </CardContent>
      </Card>
        ...
        <CardHeader className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <CardTitle className="text-2xl" style={{ color: "#2C3E50" }}>
              Editable Front Page Sections
            </CardTitle>
            <p className="text-sm text-gray-600">
              Edit customer testimonials and frequently asked questions that appear on podcastplusplus.com
            </p>
            {error && (
