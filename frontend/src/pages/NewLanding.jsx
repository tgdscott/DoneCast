    ...
    <div className="new-landing">
      ...
      <section className="nl-section" id="pricing">
        <div className="nl-container">
          ...
          <div className="nl-workflow">
            <figure className="nl-workflow-frame">
              <img
                src="/podcast-creator-workflow.jpg"
                alt="Simple podcast creator workflow"
                className="nl-workflow-image"
                loading="lazy"
              />
              <span className="nl-media-overlay" aria-hidden="true" />
            </figure>
            <div className="nl-workflow-card">
              <p className="font-semibold">Designed for total beginners and power creators alike.</p>
              <p className="text-sm text-muted-foreground">
                From your first idea to your 100th episode, PodcastPlusPlus keeps the process effortless.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="nl-section nl-section-alt">
        <div className="nl-container grid gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <div className="nl-card nl-card-media">
            <figure className="nl-media-frame">
              <img
            ...
            <div className="nl-card-body">
              ...
              <p className="nl-lead">
                Every workflow, every pixel, and every AI capability is designed to save you time while elevating your
                storytelling.
              </p>
