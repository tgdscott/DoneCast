...
_PLATFORMS: List[Dict[str, object]] = [
    ...
    },
    {
        "key": "castbox",
        "name": "Castbox",
        "summary": "Distribute to Castbox to reach listeners on Android, iOS, and web.",
        "automation": "assisted",
        "automation_notes": "We provide a pre-filled submission link with your RSS feed.",
        ...
        "instructions": [
            ...
            "Click 'Add Podcast' and paste your RSS feed URL: {rss_feed_url}.",
            "Complete the submission form. Castbox typically approves within 24-48 hours.",
        ],
        "requires_rss_feed": True,
        "rss_missing_help": "We need your Plus Plus RSS feed before we can pre-fill the Castbox form.",
    },
    {
        "key": "deezer",
        "name": "Deezer",
        "summary": "Reach music and podcast listeners on Deezer's platform.",
        "automation": "assisted",
        "automation_notes": "We provide a pre-filled submission link with your RSS feed.",
        ...
        "instructions": [
            ...
            "Click 'Add Podcast' and paste your RSS feed URL: {rss_feed_url}.",
            "Complete the metadata and submit. Deezer reviews submissions within a few business days.",
        ],
        "requires_rss_feed": True,
        "rss_missing_help": "We need your Plus Plus RSS feed before we can pre-fill the Deezer form.",
    },
    {
        "key": "podcast_addict",
        "name": "Podcast Addict",
        "summary": "Get listed on Podcast Addict, one of the most popular Android podcast apps.",
        "automation": "assisted",
        "automation_notes": "We provide a pre-filled submission link with your RSS feed.",
        "action_label": "Submit to Podcast Addict",
        "action_url_template": "https://podcastaddict.com/submit?feed={rss_feed_encoded}",
        "docs_url": "https://podcastaddict.com/faq",
        "instructions": [
            "Visit Podcast Addict's submission page.",
            "Paste your RSS feed URL: {rss_feed_url}.",
            "Complete the form and submit. Podcast Addict typically adds shows within 24-48 hours.",
        ],
        "requires_rss_feed": True,
        "rss_missing_help": "We need your Plus Plus RSS feed before we can pre-fill the Podcast Addict form.",
    },
]
