...
# Music router is included via admin/__init__.py, not here
...
# NOTE: All music endpoints (GET, POST, PUT, DELETE, upload, import-url) are in admin/music.py
# All duplicates here were causing router conflicts and have been removed

# NOTE: Music endpoints (upload, import-url, etc.) are in admin/music.py
# Duplicates here were causing router conflicts and have been removed
