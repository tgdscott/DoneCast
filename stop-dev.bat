...
echo [1/3] Stopping API window ("Podcast Pro Plus API")...
taskkill /F /T /FI "WINDOWTITLE eq Podcast Pro Plus API" >nul 2>nul
if %ERRORLEVEL% EQU 0 (
...
echo [2/3] Stopping Frontend window ("Podcast Pro Plus Frontend")...
taskkill /F /T /FI "WINDOWTITLE eq Podcast Pro Plus Frontend" >nul 2>nul
if %ERRORLEVEL% EQU 0 (
